...
public class CreatePostView
{
    ...
    private Task CreatePostAsync()
    {
        while (true)
        {
            Console.WriteLine("------------Bestieee you are creating a post----------");
            ...
            while (string.IsNullOrEmpty(title))
            {
                ...
                {
                    Console.WriteLine("Title cannot be empty bestieee.");
                    continue;
                }
            ...
            Console.WriteLine("Insert post content niunia uhuuuuu:");
            string? content = null;
            ...
            Console.WriteLine("Please insert the ID of the user(bestieee) that created the post(that slayying content):");
            ...
            while (true)
            {
                ...
                {
                    var userExist = UserExistsAsync(userId).Result;
                    if(userExist)
                    {
                        break;
                    }
